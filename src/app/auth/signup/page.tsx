...
export default function SignUpPage() {
  ...
  const handleOAuthSignIn = async (provider: OAuthProvider) => {
    ...
    if (error) {
      ...
      setError(`${provider === "google" ? "Google" : "X"}登録に失敗しました。SupabaseのAuthentication設定を確認してください。`);
    }
  };
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/35 bg-white/[0.22] shadow-[0_30px_120px_rgba(44,21,70,0.34)] backdrop-blur-3xl">
            ...
            <div className="relative p-5 sm:p-7">
              ...
              <div className="mb-6">
                ...
                <h2 className="text-3xl font-black tracking-tight text-white drop-shadow-[0_4px_18px_rgba(52,25,76,0.4)] sm:text-4xl">アカウントを作る</h2>
                <p className="mt-2 text-sm font-semibold leading-relaxed text-white/[0.78] drop-shadow-[0_2px_10px_rgba(52,25,76,0.35)]">
                  メール、Google、Xで登録できます。登頂記録を残す準備をしましょう。
                </p>
              </div>
              ...
              <div className="grid gap-3">
                ...
                >
                  <span className="flex items-center gap-3">
                    ...
                    {oauthLoading === "google" ? "Googleへ移動中..." : "Googleで登録"}
                  </span>
                ...
                >
                  <span className="flex items-center gap-3">
                    ...
                    {oauthLoading === "twitter" ? "Xへ移動中..." : "Xで登録"}
                  </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label className="block">
                  ...
                  <p className="mt-1.5 flex items-center gap-1.5 text-xs font-bold text-white/[0.7]">
                ...
                <label className="block">
                  <span className="mb-2 block text-xs font-black uppercase tracking-[0.16em] text-white/[0.76]">パスワード確認</span>
                  <div className="relative">
                    <FieldIcon>
                      <LockKeyhole className="h-4 w-4" />
                    </FieldIcon>
              ...
              <div className="mt-6 grid gap-2 text-center text-sm font-bold">
                <Link href="/auth/login" className="text-white transition drop-shadow-[0_2px_10px_rgba(52,25,76,0.35)] hover:text-amber-100">
                  ログインはこちら
                </Link>
