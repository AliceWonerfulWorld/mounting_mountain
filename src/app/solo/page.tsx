              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                >
                  <svg viewBox="0 0 1200 400" preserveAspectRatio="none" className="w-full h-full">
                    ...
                    <path d="M0,400 L200,180 L400,280 L600,100 L800,240 L1000,140 L1200,300 L1200,400 Z" fill="url(#mountain-grad-2)" />
                    {/* 雪の頂 */}
                    <path d="M600,100 L580,115 L570,108 L560,118 L600,100 L640,118 L630,108 L620,115 Z" fill="rgba(255,255,255,0.9)" />
                ...
                >
                  <svg viewBox="0 0 1200 400" preserveAspectRatio="none" className="w-full h-full">
                    ...
                    <path d="M0,400 L150,200 L300,280 L450,120 L600,80 L750,180 L900,150 L1050,240 L1200,200 L1200,400 Z" fill="url(#mountain-grad-3)" />
                    {/* 雪の頂（メイン） */}
                    <path d="M450,120 L430,138 L420,130 L410,142 L400,135 L450,120 L500,135 L490,142 L480,130 L470,138 Z" fill="rgba(255,255,255,0.95)" />
              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                >
                  <svg viewBox="0 0 1200 400" preserveAspectRatio="none" className="w-full h-full">
                    ...
                    <path d="M0,400 L200,200 L400,260 L600,140 L800,220 L1000,180 L1200,280 L1200,400 Z" fill="url(#forest-mountain-2)" />
                    {/* 山の稜線に雪 */}
