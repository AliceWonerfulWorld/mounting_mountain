...
export function RouteConnector({ isUnlocked, index = 0 }: RouteConnectorProps) {
    return (
        <div 
            className="flex justify-center my-1.5 md:my-2"
            style={{
        ...
        >
            <div className="relative">
                ...
                <div
                    className={clsx(
                        "w-0.5 md:w-1 h-6 md:h-8 rounded-full transition-all duration-700",
                        isUnlocked
                ...
                {isUnlocked && (
                    <div
                        className="absolute inset-0 w-0.5 md:w-1 h-6 md:h-8 rounded-full blur-sm"
                        style={{
